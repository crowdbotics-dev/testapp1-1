"""
Django settings for testapp1_1 project.
...
WSGI_APPLICATION = 'testapp1_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp1_1 API",
    "DESCRIPTION": "API documentation for testapp1_1 App",
    "VERSION": "v1",
}
