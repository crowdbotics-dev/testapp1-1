...
const testappAPI = axios.create({
  baseURL: "https://testapp1-1.botics.co",
...
function modules_two_factor_authentication_enable_2fa_retrieve(payload) {
  return testappAPI.get(`/modules/two-factor-authentication/enable/2fa`)
}
function modules_two_factor_authentication_enable_2fa_create(payload) {
  return testappAPI.post(`/modules/two-factor-authentication/enable/2fa`)
}
function modules_two_factor_authentication_enable_2fa_destroy(payload) {
  return testappAPI.delete(`/modules/two-factor-authentication/enable/2fa`)
}
function modules_two_factor_authentication_google_authenticator_qr_retrieve(
  payload
) {
  return testappAPI.get(
...
function modules_two_factor_authentication_send_otp_create(payload) {
  return testappAPI.post(`/modules/two-factor-authentication/send/otp`)
}
function modules_two_factor_authentication_verify_otp_create(payload) {
  return testappAPI.post(`/modules/two-factor-authentication/verify/otp`)
}
